...
PERMISSION_COMMANDS = {
    ...
    "hardlink": PermissionFunctions.createHardLink,
    "softlink": PermissionFunctions.createSoftLink,
    "viewlink": PermissionFunctions.viewLink,
    "updatelink": PermissionFunctions.updateLink,
    "deletelink": PermissionFunctions.deleteLink,
    "listlinks": PermissionFunctions.listLinksInDirectory,
    "linkinfo": PermissionFunctions.linkInfo,
